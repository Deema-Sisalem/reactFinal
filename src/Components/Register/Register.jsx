...
export default function Register() {
    ...
    return (
        ...
        <div className="max-w-lg mx-auto  bg-white dark:bg-gray-800 rounded-lg shadow-xl px-8 py-10 flex flex-col items-center mt-10">
            <h1 className="text-2xl font-bold text-center text-gray-700 dark:text-gray-200 mb-8 uppercase">Registration Form</h1>
            <form onSubmit={handleSubmit} action="#" className="w-full flex flex-col gap-4">
                ...
                <div className="flex items-start flex-col justify-start">
                    ...
                    <input onChange={handleChange} value={values.name} type="text" id="name" name="name" className="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-teal-500" />
                    {touched.name && errors.name && <p className='text-red-400'>{errors.name}</p>}
                </div>

                <div className="flex items-start flex-col justify-start">
                    <label htmlFor="email" className="text-sm text-gray-700 dark:text-gray-200 mr-2">Email:</label>
                    <input onChange={handleChange} value={values.email} t type="email" id="email" name="email" className="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-teal-500" />
                ...
                <div className="flex items-start flex-col justify-start">
                    ...
                    <input onChange={handleChange} value={values.rePassword} type="password" id="confirmPassword" name="rePassword" className="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-teal-500" />
                ...
                <div className="flex items-start flex-col justify-start">
                    ...
                    <input onChange={handleChange} value={values.phone} type="tel" id="phone" name="phone" className="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-teal-500" />
                    {touched.phone && errors.phone && <p className='text-red-400'>{errors.phone}</p>}
                </div>

                <button type="submit" className="bg-teal-500 hover:bg-teal-600 text-white font-medium py-2 px-4 rounded-md shadow-sm disabled:bg-slate-300" disabled={isLoading}>Register {isLoading && <i className="fa-solid fa-spinner fa-spin"></i>}</button>
